                      ...
                      <Table sx={{ minWidth: 650, mt: 2 }} size="small" aria-label="a dense table">
                        <TableHead>
                          <TableRow sx={{ bgcolor: ' #243238' }}>
                            ...
                            <TableCell sx={{ color: 'white' }} align="center">Tipo de usuário</TableCell>
                            <TableCell sx={{ color: 'white' }} align="center">Data de Cadastro</TableCell>
                        ...
                        <TableBody>
                          {usuarios.map((row) => (
                            ...
                            >
                              ...
                              <TableCell align="center">{row.tipo_usuario === 2 ? <Chip label="Administrador" color="primary" /> : <Chip label="Pambaleiro" color="secondary" />}</TableCell>
